...
from utils.functions import generate_forecast_with_ci, human_readable_numbers,cumulative_production
...
def update_predict_plot(toast_icon, n_clicks, commodity, forecast_input: str):
    ...
    # Populate Toast elements (summation cards)
    toast_fore_prod = human_readable_numbers(round(cumulative_production(y_forecast),0)) + units
